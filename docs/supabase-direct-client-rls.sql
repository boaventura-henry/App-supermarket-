...
-- Bucket expected by the frontend: profile-photos.
-- Run after creating the bucket in Supabase Storage, or keep the insert below
-- if your SQL role can manage storage buckets.
